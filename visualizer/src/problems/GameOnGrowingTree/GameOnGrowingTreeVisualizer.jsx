...
export default function GameOnGrowingTreeVisualizer() {
    ...
    const handleTreePointerMove = useCallback(
        (event) => {
    ...
    const handleTreeWheel = useCallback((event) => {
        ...
        const viewY =
            ((event.clientY - rect.top) * TREE_VIEWBOX_HEIGHT) / rect.height;
                    ...
                    <div className="gogt-panel-body">
                        ...
                        {dpSnapshot ? (
                            <div className="gogt-dp-state">
                                <div className="gogt-dp-state-head">
                                    DP state for rendered prefix
                                </div>
                        ...
                        {currentTree?.truncated ? (
                            <div className="gogt-tree-truncated">
                                Rendering first {MAX_TREE_NODES_TO_RENDER} nodes only for
                                clarity.
                            </div>
                        ) : null}
                    </div>
